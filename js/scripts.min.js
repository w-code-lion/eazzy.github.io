...
!(function (e, t) {
    ...
    function w(e, o) {
        if ("viewport" === o) {
            ...
            var l = 0,
                u = 0;
            o && ((p = o.width), (a = o.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((l = o.offsetLeft), (u = o.offsetTop))), (e = x((e = { width: p, height: a, x: l + f(e), y: u })));
        ...
        return (
            ...
            c
                ? Object.assign(
                      Object.assign({}, r),
                      {},
                      (((d = {})[h] = a ? "0" : ""), (d[m] = u ? "0" : ""), (d.transform = 2 > (b.devicePixelRatio || 1) ? "translate(" + e + "px, " + l + "px)" : "translate3d(" + e + "px, " + l + "px, 0)"), d)
                  )
                ...
                fn: function (e) {
                    ...
                    (e = void 0 === (e = n.gpuAcceleration) || e),
                        ...
                        null != t.modifiersData.arrow &&
                            (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), W(Object.assign(Object.assign({}, e), {}, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1 })))),
                    ...
                    if (((e = e.name), !t.modifiersData[e]._skip)) {
                                ...
                                "auto" === y(n)
                                    ? (function (e, t) {
                                          ...
                                          var c = i.reduce(function (t, i) {
                                              return (t[i] = k(e, { placement: i, boundary: n, rootBoundary: r, padding: o })[y(i)]), t;
                                          }, {});
                        ...
                        for (var h = d[0], g = 0; g < d.length; g++) {
                            var b = d[g],
                                ...
                                w = x ? "width" : "height",
                                j = k(t, { placement: b, boundary: s, rootBoundary: f, altBoundary: c, padding: a });
                            if (
            ...
            },
            {
                ...
                fn: function (e) {
                    ...
                    var a = n.tetherOffset,
                        s = void 0 === a ? 0 : a;
                    (n = k(t, { boundary: n.boundary, rootBoundary: n.rootBoundary, padding: n.padding, altBoundary: n.altBoundary })), (a = y(t.placement));
            ...
            },
            {
                ...
                effect: function (e) {
                    ...
                    if (((r = void 0 === r ? "[data-popper-arrow]" : r), (n = void 0 === (n = n.padding) ? 0 : n), null != r)) {
                        ...
                        O(t.elements.popper, r) && ((t.elements.arrow = r), (t.modifiersData[e + "#persistent"] = { padding: D("number" != typeof n ? n : P(n, q)) }));
                    }
                },
                requires: ["popperOffsets"],
...
!(function (t, e) {
    ...
    function S(t) {
        ...
        function i(n, r) {
            ...
            r.theme ? o.setAttribute("data-theme", r.theme) : o.removeAttribute("data-theme"),
                ...
                (n.content === r.content && n.allowHTML === r.allowHTML) || P(a, t.props),
                r.arrow ? (s ? n.arrow !== r.arrow && (o.removeChild(s), o.appendChild(j(r.arrow))) : o.appendChild(j(r.arrow))) : s && o.removeChild(s);
        }
        return (r.className = "tippy-content"), r.setAttribute("data-state", "hidden"), P(r, t.props), e.appendChild(n), n.appendChild(r), i(t.props, t.props), { popper: e, onUpdate: i };
    }
    S.$$tippy = !0;
    var B = 1,
        H = [],
    ...
    function N(e, n) {
        var a,
            ...
            X = {
                ...
                setProps: function (t) {
                    ...
                    var n = X.props,
                        r = V(e, Object.assign({}, X.props, {}, t, { ignoreAttributes: !0 }));
        ...
        function vt(t, n, r) {
            void 0 === r && (r = !1),
                c(X.props.triggerTarget || e).forEach(function (e) {
                    e.addEventListener(t, n, r), N.push({ node: e, eventType: t, handler: n, options: r });
                });
        }
        function mt() {
            var t;
            Q() && (vt("touchstart", ht, { passive: !0 }), vt("touchend", yt, { passive: !0 })),
        ...
        function ht(t) {
            ...
            if (X.state.isEnabled && !wt(t) && !j) {
                ...
                (b = t),
                    ...
                    "click" === t.type && (X.props.trigger.indexOf("mouseenter") < 0 || R) && !1 !== X.props.hideOnClick && X.state.isVisible ? (n = !0) : At(t),
                    "click" === t.type && (R = !n),
                    n && !r && Ot(t);
            }
        }
        ...
        function Et() {
            ...
            var n = X.props,
                ...
                s = n.moveTransition,
                p = Z() ? I(q).arrow : null,
                u = a ? { getBoundingClientRect: a, contextElement: a.contextElement || tt() } : e,
                c = [
            ...
            Z() && p && c.push({ name: "arrow", options: { element: p, padding: 3 } }),
                c.push.apply(c, (null == r ? void 0 : r.modifiers) || []),
                (X.popperInstance = t.createPopper(u, q, Object.assign({}, r, { placement: i, onFirstUpdate: A, modifiers: c })));
        }
        function Tt() {
    ...
    return (
        ...
        (_.createSingleton = function (t, e) {
            ...
            var p = {
                ...
                c = _(v(), Object.assign({}, u(e, ["overrides"]), { plugins: [p].concat(e.plugins || []), triggerTarget: i })),
                f = c.setProps;
            return (
                ...
                (c.setInstances = function (t) {
                    s(!0), (r = t), s(!1), a(), c.setProps({ triggerTarget: i });
                }),
                c
            );
        }),
